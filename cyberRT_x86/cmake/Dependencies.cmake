set(fastrtps_DIR ${cyber_SOURCE_DIR}/third_party/fastrtps/lib/fastrtps/cmake)
...
set(fastcdr_DIR ${cyber_SOURCE_DIR}/third_party/fastcdr/lib/fastcdr/cmake)
...
set(Protobuf_ROOT ${cyber_SOURCE_DIR}/third_party/protobuf)
set(Protobuf_DIR ${cyber_SOURCE_DIR}/third_party/lib/cmake/protobuf)
...
set(Poco_DIR ${cyber_SOURCE_DIR}/third_party/Poco/lib/cmake/Poco)
...
#set(gflags_DIR /home/lpj/Software/gflags/lib/cmake/gflags)
#find_package(gflags REQUIRED CONFIG)
#message(STATUS "version: ${gflags_VERSION}")
#message(STATUS "Found gflags: ${gflags_LIBRARIES}")
include_directories(${cyber_SOURCE_DIR}/third_party/gflags/include)
link_directories(${cyber_SOURCE_DIR}/third_party/gflags/lib)


#set(glog_DIR /home/lpj/Software/glog/lib/cmake/glog)
#find_package(glog REQUIRED CONFIG)
#message(STATUS "version: ${glog_VERSION}")
#message(STATUS "Found glog: ${glog_LIBRARIES}")
include_directories(${cyber_SOURCE_DIR}/third_party/glog/include)
link_directories(${cyber_SOURCE_DIR}/third_party/glog/lib)

include_directories(${cyber_SOURCE_DIR}/third_party/gtest/include)
link_directories(${cyber_SOURCE_DIR}/third_party/gtest/lib)
