...
using drivers::PointXYZIT;
using drivers::velodyne::DUAL;
using drivers::velodyne::HDL32E;
using drivers::velodyne::HDL64E_S2;
using drivers::velodyne::HDL64E_S3D;
using drivers::velodyne::HDL64E_S3S;
using drivers::velodyne::LAST;
using drivers::velodyne::STRONGEST;
using drivers::velodyne::VelodynePacket;
using drivers::velodyne::VelodyneScan;
using drivers::velodyne::VLP16;
using drivers::velodyne::VLP32C;
using drivers::velodyne::VLS128;
...
class VelodyneParser {
 public:
  VelodyneParser() {}
  explicit VelodyneParser(const config::VelodyneConfig& config);
...
class Velodyne64Parser : public VelodyneParser {
 public:
  explicit Velodyne64Parser(const config::VelodyneConfig& config);
  ~Velodyne64Parser() {}
...
class Velodyne32Parser : public VelodyneParser {
 public:
  explicit Velodyne32Parser(const config::VelodyneConfig& config);
  ~Velodyne32Parser() {}
...
class Velodyne16Parser : public VelodyneParser {
 public:
  explicit Velodyne16Parser(const config::VelodyneConfig& config);
  ~Velodyne16Parser() {}
...
class Velodyne128Parser : public VelodyneParser {
 public:
  explicit Velodyne128Parser(const config::VelodyneConfig& config);
  ~Velodyne128Parser() {}
...
class VelodyneParserFactory {
 public:
  static VelodyneParser* CreateParser(config::VelodyneConfig config);
};
