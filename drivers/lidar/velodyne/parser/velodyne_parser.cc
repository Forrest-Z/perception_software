...
VelodyneParser::VelodyneParser(const config::VelodyneConfig &config)
...
VelodyneParser *VelodyneParserFactory::CreateParser(config::VelodyneConfig source_config) {
  config::VelodyneConfig config = source_config;
